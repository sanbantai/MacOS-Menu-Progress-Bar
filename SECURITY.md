...
Report them privately through GitHub's **Security → Report a vulnerability** workflow. If private vulnerability reporting is unavailable, email `gruzmanworks@gmail.com` with:
